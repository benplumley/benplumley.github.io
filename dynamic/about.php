		...
		<div id="wrap" class="curtain">
			...
			<div class="container">
				<div class="main-box">
						...
						<table>
							...
							<tr>
								...
								<td>
									...
									<span class="label label-default" onclick="showIt('JavaScript')" href="#">JavaScript</span> <!--Important space-->
									<span class="label label-default" onclick="showIt('PHP')" href="#">PHP</span>
								</td>
							</tr>
							<tr>
								<td class="table-year table-year-first">2015</td>
								<td class="table-timeline"></td>
								<td>
									<span class="glyphicon glyphicon-minus table-glyphicon"></span>
								</td>
					...
					<p>I was born in 1995.</p><br>
					<h2 id="Windows">Windows</h2>
					<p>In 2000, I started playing with my dad's Windows PC. I have used Windows as my primary OS since then, both for work and recreation. My primary and secondary schools and my sixth form college have all primarily used Windows, and I consider myself proficient in its use.</p><br>
					...
					<h2 id="iOS">iOS</h2>
					<p>In 2006, I bought an iPod Touch (2nd gen). It was my first iOS device, and the closest thing I'd had to a smartphone. I later updated to a 4th gen iPod Touch, but I stopped using iOS when I got my first Android phone. However, I was later invited to co-author a policy at my Secondary school which would introduce iOS devices to the classroom to be used as an aid to education. This project was successful, and by 2012, my school had spent over &pound;20,000 on implementing it.</p><br>
					<h2 id="OSX">OSX</h2>
					...
					<p>At my sixth form college, programming is taught using Visual Basic. The first year is spent writing console applications. Visual Basic is the first language I really experimented with, and is a language I've used in most of my projects. </p><br>
